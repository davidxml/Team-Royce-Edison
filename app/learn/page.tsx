    ...
    <SignedIn>
      ...
      >
        ...
        <aside className="w-20 lg:w-64 border-r border-gray-200 fixed h-full bg-white z-40 hidden md:flex flex-col px-4 py-6">
          {/* Logo */}
          <Link href="/dashboard" className="mb-8 px-2 lg:px-4 cursor-pointer">
          ...
          <div className="flex items-center gap-4 mb-10">
            <div className="group relative flex items-center gap-2 cursor-pointer">
              <img
                ...
                alt="Flag"
              />
              <span className="font-bold text-gray-400 text-sm hover:bg-gray-100 p-2 rounded-lg transition-colors">
                NG Curriculum
              </span>
            </div>

      ...
      <DialogContent className="sm:max-w-[600px] bg-white rounded-3xl border-0 shadow-2xl p-0 overflow-hidden font-sans">
        ...
        >
          ...
          <div className="bg-gray-50 border-b-2 border-gray-100 p-6 flex items-center gap-3">
            <div className="w-10 h-10 bg-[#4854F6] rounded-xl flex items-center justify-center text-white shadow-[0_4px_0_#353EB5]">
              {step === 1 ? (
                        ...
                        return (
                          <button
                            ...
                            className={`
                                        ...
                                        ${
                                          isSelected
                                            ? "bg-[#4854F6] border-[#353EB5] border-b-[4px] text-white"
                                            : "bg-white border-gray-200 border-b-[4px] text-gray-500 hover:bg-gray-50 hover:border-gray-300"
                                        }
                                    `}
                          >
                            <span
                        ...
                        return (
                          <div
                            ...
                            className={`
                                            ...
                                            ${
                                              isSelected
                                                ? "bg-[#EEF2FF] border-[#4854F6] border-b-[4px]"
                                                : "bg-white border-gray-200 border-b-[4px] hover:bg-gray-50"
                                            }
                                        `}
                          >
                            <span
          ...
          <DialogFooter className="p-6 bg-gray-50 border-t-2 border-gray-100 flex items-center justify-between gap-4">
            {step === 2 ? (
              <button
                onClick={handleBack}
                className="btn-pressable px-6 py-3 rounded-2xl font-extrabold text-gray-500 bg-white border-2 border-gray-200 border-b-[4px] hover:bg-gray-100 uppercase tracking-wider text-sm flex items-center gap-2"
              >
            ...
            {step === 1 ? (
              <button
                ...
                className={`
                            ...
                            ${
                              selectedGrade !== null
                                ? "bg-[#4854F6] text-white border-[#353EB5] border-b-[4px] shadow-sm"
                                : "bg-gray-200 text-gray-400 border-gray-300 border-b-[4px] cursor-not-allowed"
                            }
                        `}
              >
